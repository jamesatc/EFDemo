...
@interface EFBannerController : NSObject <EFAdControllerDelegate, CLLocationManagerDelegate>
...
- (EFBannerController *)initWithViewController:(UIViewController *)viewController andAdView:(EFAdView *)adView andDelegate:(id)EFDelegate;
- (void)startAd;
- (void)stopAd;
- (bool)adRunning;
